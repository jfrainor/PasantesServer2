...
db.permisos = require("./permisosModel.js")(sequelize, DataTypes);
db.tipo_evaluacion = require("./tipo_evaluacion.js")(sequelize, DataTypes);
db.Tipo_Permisos = require("./Tipo_permisosModel.js")(sequelize, DataTypes);
...
db.usuarios.hasMany(db.permisos, { foreignKey: "usuario_id" });
...
db.permisos.belongsToMany(db.Tipo_Permisos, {
  through: "permisos_Tipo_Permisos",
  foreignKey: "permiso_id",
  otherKey: "tipo_permiso_id",
});
